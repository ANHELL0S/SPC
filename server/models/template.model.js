import {
	templateScheme,
	relation_tag_template_Scheme,
	relation_parameter_article_Scheme,
} from './postgresql/schemes.js'
import { relation_parameter_article_Model } from './relation_parameter_article.model.js'
...
export class templateModel {
	...
	static async checkParameter(id) {
		try {
			const template = await relation_parameter_article_Scheme.findOne({ where: { id_parameter_fk: id } })
			return template !== null
		} catch (error) {
